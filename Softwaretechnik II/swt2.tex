...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \end{minipage}
    \begin{minipage}{.5\textwidth}
      \includegraphics[width=\linewidth]{imgs/XP2}
    \end{minipage}
  ...
  \begin{itemize}
    ...
    \end{minipage}
    \begin{minipage}{.5\textwidth}
      \includegraphics[width=\linewidth]{imgs/scrum}
    \end{minipage}
...
\begin{itemize}
  ...
  \end{minipage}
  \begin{minipage}{.5\textwidth}
    \includegraphics[width=\linewidth]{imgs/observer}
  \end{minipage}
  \item Model View Controller \& Observer\\
  \includegraphics[width=.7\linewidth]{imgs/mvcobs}
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \includegraphics[width=\linewidth]{imgs/paladiomodelle}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \end{minipage}
      \begin{minipage}{.5\textwidth}
        \includegraphics[width=\textwidth]{imgs/activerecord}
      \end{minipage}
      \begin{minipage}{.5\textwidth}
      ...
      \end{minipage}
      \begin{minipage}{.5\textwidth}
        \includegraphics[width=\textwidth]{imgs/rdgateway}
      \end{minipage}
      \item Identity Map (Muster)\\
      \includegraphics[width=.7\textwidth]{imgs/identitymap}
      \begin{itemize}
        \item Zugriff auf DB
      ...
      \includegraphics[width=.7\textwidth]{imgs/datamapper}
      \begin{itemize}
    ...
    \begin{itemize}
      ...
      \includegraphics[width=.5\textwidth]{imgs/concretetableinheritance}
      \begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \includegraphics[width=.7\textwidth]{imgs/lchc}
    \begin{itemize}
    ...
    \includegraphics[width=.7\textwidth]{imgs/stratpat}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \end{minipage}
      \begin{minipage}{.5\textwidth}
        \includegraphics[width=\textwidth]{imgs/liskov}
      \end{minipage}
      ...
      \begin{itemize}
        \begin{minipage}{.5\textwidth}
          \item \glqq A. High level modules should not depend upon low level modules. Both should depend upon abstractions.
          B. Abstractions should not depend upon details. Details should depend upon abstractions.\grqq
        ...
        \end{minipage}
        \begin{minipage}{.5\textwidth}
          \includegraphics[width=\textwidth]{imgs/dip}
        \end{minipage}
    ...
    \begin{itemize}
      ...
      \includegraphics[width=.7\linewidth]{imgs/commenting}
    \end{itemize}
    ...
    \item Single Level of Abstraction (SLA)\\
    \includegraphics[width=.5\textwidth]{imgs/SLA}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \end{minipage}
    \begin{minipage}{.5\textwidth}
      \includegraphics[width=\textwidth]{imgs/CLA}
    \end{minipage}
